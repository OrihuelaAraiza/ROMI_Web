  ...
  return (
    <main className="relative left-1/2 flex min-h-[calc(100dvh-4rem)] w-screen -translate-x-1/2 items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-2xl animate-fade-in-up">
        <div className="card-premium bg-[var(--surface-card)]/95 p-5 backdrop-blur-xl sm:p-8">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-romi border-2 border-[var(--surface-card-border)] mb-4 shadow-lg animate-bounce-slow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        {watchRole === "doctor" && (
          <div className="romi-panel space-y-4 animate-slide-down">
            <div className="flex items-center gap-2 mb-2">
              <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <h3 className="font-semibold text-sm text-[var(--text-primary)] font-fredoka-one">
        ...
        <button
          type="submit"
          className="romi-action w-full font-fredoka-one disabled:cursor-not-allowed disabled:opacity-50"
